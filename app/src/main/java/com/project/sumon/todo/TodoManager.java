...
public class TodoManager {
    ...
    public ArrayList<Todo> getTodosByCategoryId(int id) {
        ...
        Cursor cursor = database.query(DBHelper.TABLE_TODO, new String[]{DBHelper.KEY_TODO_ID, DBHelper.KEY_TITLE, DBHelper.KEY_DESCRIPTION, DBHelper.KEY_TYPE, DBHelper.KEY_CATEGORY_ID, DBHelper.KEY_CREATED_AT, DBHelper.KEY_STATUS}, DBHelper.KEY_CATEGORY_ID + " = " + id, null, null, null, DBHelper.KEY_TODO_ID + " DESC", null);
        cursor.moveToFirst();
