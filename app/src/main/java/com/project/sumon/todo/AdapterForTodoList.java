...
public class AdapterForTodoList extends ArrayAdapter<Todo> {
    ...
    static class ViewHolder {
        TextView todoTitleTV, dateTV;
        ImageView statusImageV, todoTypeImageV, dateIconImgView;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.dateIconImgView = (ImageView) convertView.findViewById(R.id.dateIconImgView);
        ...
        viewHolder.dateTV.setText(todoList.get(position).getCreated_at().toString());
        ...
        if (status == 0) {
            ...
            viewHolder.dateIconImgView.setImageResource(R.mipmap.ic_datelabel);

        } else {
            viewHolder.statusImageV.setImageResource(R.mipmap.ic_done);

            viewHolder.dateIconImgView.setImageResource(R.mipmap.ic_done);
        }
        return convertView;
    }
}
